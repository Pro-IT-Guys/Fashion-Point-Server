...
const product_model_1 = __importDefault(
...
const scheduleCronJobs = offer => {
  ...
  if (startFrom && endAt) {
    ...
    node_cron_1.default.schedule(endAtCronExpression, () =>
      __awaiter(void 0, void 0, void 0, function* () {
        try {
          const originalProducts = yield product_model_1.default.updateMany(
    ...
    node_cron_1.default.schedule(startFromCronExpression, () =>
      __awaiter(void 0, void 0, void 0, function* () {
        try {
          const updatedProducts = yield product_model_1.default.updateMany(
            { _id: { $in: offer.product } },
            { $set: { isVisibleOffer: true } }
          )
          const updateOffer = yield offer_model_1.default.findByIdAndUpdate(
            _id,
            { $set: { isVisible: true } },
            { new: true }
          )
