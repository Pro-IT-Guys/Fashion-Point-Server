...
const CreateFee = () =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (const {
      ...
      phoneCode,
      code,
    } of deliveryFee_constant_1.countriesWithCodes) {
      const states = []
      for (const state of country_state_city_1.State.getStatesOfCountry(code)) {
        const cities = country_state_city_1.City.getCitiesOfState(
          code,
          state.isoCode
        )
        if (cities.length > 0) {
    ...
    if (!deliveryFeeData) {
      throw new ApiError_1.default(
        ...
        'Delivery fee not created'
      )
    }
    return deliveryFeeData
  })
const updateFee = (id, dataPayload) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getFeeOfLocation = (countryId, stateCode, city_name) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c
    ...
    if (
      ((_a = state.cities) === null || _a === void 0 ? void 0 : _a.length) &&
      city_name
    ) {
      const city = state.cities.find(city => city.city_name === city_name)
      if (!city) {
      ...
      return {
        ...
        delivery_fee:
          (_b = city.delivery_fee) !== null && _b !== void 0 ? _b : 0,
      ...
      return {
        country: fullData.country,
        delivery_fee:
          (_c = state.delivery_fee) !== null && _c !== void 0 ? _c : 0,
        state_name: state.state_name,
      }
    }
  })
