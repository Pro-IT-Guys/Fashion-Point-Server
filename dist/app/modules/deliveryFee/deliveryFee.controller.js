...
const createFee = (0, catchAsync_1.default)((req, res) =>
...
const updateFee = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const deliveryData = req.body
    const { id } = req.params
    const data = yield deliveryFee_service_1.DeliveryFeeService.updateFee(
      id,
      deliveryData
    )
    const responseData = {
...
const getAllFees = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getFeeOfLocation = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
