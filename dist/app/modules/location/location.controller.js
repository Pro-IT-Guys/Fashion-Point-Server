...
const getCurrentLocation = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const location = yield location_service_1.LocationService.getCurrentLocation(geolocationURL);
    const responseData = {
