...
const createOrder = (orderData) => __awaiter(void 0, void 0, void 0, function* () {
    const { userId, orderItems, shippingAddress } = orderData, rest = __rest(orderData, ["userId", "orderItems", "shippingAddress"]);
    const { country, state, city } = shippingAddress;
    const session = yield mongoose_1.default.startSession();
    try {
        session.startTransaction();
        //   Firstly get the delivery fee of the location of shipping address
        const deliveryFeeData = yield deliveryFee_service_1.DeliveryFeeService.getFeeOfLocation(country, state, city);
        ...
        const order = (yield order_model_1.default.create(Object.assign({ userId,
            orderItems,
            shippingAddress }, rest))).populate([
            { path: 'userId' },
...
const getAllOrder = (filters, paginationOption) => __awaiter(void 0, void 0, void 0, function* () {
...
const updateOrder = (orderId, orderData) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!updatedOrder)
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'Order not updated');
    return updatedOrder;
});
