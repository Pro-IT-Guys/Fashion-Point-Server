...
const updateOrder = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const orderData = req.body
    const data = yield order_service_1.OrderService.updateOrder(
      orderId,
      orderData
    )
    const responseData = {
...
const getOrderByUserId = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getOrderByOrderId = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const orderId = req.params.id
