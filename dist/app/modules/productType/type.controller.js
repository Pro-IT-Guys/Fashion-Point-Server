...
const createType = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const type = yield type_service_1.TypeService.createType(req.body);
    const responseData = {
