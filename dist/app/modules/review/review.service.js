...
const createReview = (review) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (isExist)
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, `You already reviewed this product`);
    let newReview = null;
    ...
    try {
        ...
        if (!newReview)
            throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, `Review not submitted`);
        ...
        const updatedProduct = yield product_model_1.default.findByIdAndUpdate(review.productId, { review: newProductReview }, { new: true });
        if (!updatedProduct)
            throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, `Something went wrong while submitting review`);
...
const getAllReviews = (productId) => __awaiter(void 0, void 0, void 0, function* () {
    const reviews = yield review_model_1.default.find({ productId }).populate('userId');
    if (!reviews)
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, `No reviews found`);
