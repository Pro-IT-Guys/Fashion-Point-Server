...
const createTermsCondition = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result =
      yield terms_service_1.TermsConditionService.createTermsConditionService(
        req.body
      )
    const responseData = {
...
const getTermsCondition = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result =
      yield terms_service_1.TermsConditionService.getTermsConditionService()
    const responseData = {
