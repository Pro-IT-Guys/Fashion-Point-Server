...
const createTermsConditionService = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const existingTerms = yield terms_model_1.default.findOne();
    if (existingTerms) {
        ...
        const terms = new terms_model_1.default(data);
        yield terms.save();
        return terms;
    }
});
const getTermsConditionService = () => __awaiter(void 0, void 0, void 0, function* () {
    const existingTerms = yield terms_model_1.default.findOne();
    return existingTerms;
});
