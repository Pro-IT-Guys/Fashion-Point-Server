...
const getOffer = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
const deleteOfferById = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const offer = yield offer_service_1.offerService.deleteOfferById(req.params.id);
    const responseData = {
        data: offer,
