...
const createOffer = (offerData) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const checkAnyOfferExists = yield offer_model_1.default.findOne({});
    if (checkAnyOfferExists) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'An offer already exists, please delete it first');
    }
...
const getOffer = () => __awaiter(void 0, void 0, void 0, function* () {
...
const deleteOfferById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const offer = yield offer_model_1.default.findByIdAndDelete(id);
    if (!offer) {
        throw new ApiError_1.default(http_status_1.default.NOT_FOUND, 'Offer not found');
    }
    const session = yield mongoose_1.default.startSession();
    try {
        session.startTransaction();
        const updatedProducts = yield product_model_1.default.updateMany({ _id: { $in: offer.product } }, { $set: { discountPrice: 0, isVisible: false } });
        if (updatedProducts.modifiedCount <= 0) {
            throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'Unable to update product prices');
        }
        yield session.commitTransaction();
