...
const addToCart = (cartData) => __awaiter(void 0, void 0, void 0, function* () {
    const isExist = yield cart_model_1.default.findOne({ userId: cartData.userId });
    if (isExist)
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'Cart already exists');
    const cart = yield cart_model_1.default.create(cartData);
    yield cart.populate('product.productId');
    if (!cart)
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'Failed to add items to cart');
    return cart;
});
const updateCart = (cartId, cartData) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (existingCart) {
        if (cartData.product) {
            ...
            const existingProductIndex = existingCart.product.findIndex(item => item.productId.equals(updatedProduct.productId));
            ...
            const cart = yield cart_model_1.default
                .findByIdAndUpdate(cartId, { product: existingCart.product }, { new: true })
                .populate('product.productId');
            if (!cart)
...
const bulkUpdateCart = (cartId, cartData) => __awaiter(void 0, void 0, void 0, function* () {
    const isExist = yield cart_model_1.default.findById(cartId);
    if (!isExist)
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'Cart not found');
    const updatedCart = yield cart_model_1.default.findByIdAndUpdate(cartId, { $set: { product: cartData.product } }, { new: true });
    if (!updatedCart)
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'Failed to update cart');
    return updatedCart;
});
const getCartByUserId = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    const cart = yield cart_model_1.default.findOne({ userId }).populate('product.productId');
    console.log(cart);
    if (!cart)
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'Cart not found');
    return cart;
});
const getCartByCartId = (cartId) => __awaiter(void 0, void 0, void 0, function* () {
    const cart = yield cart_model_1.default.findById(cartId).populate('product.productId');
    if (!cart)
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'Cart not found');
    return cart;
});
...
const deleteAProductFromCart = (cartId, productId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const existingCart = yield cart_model_1.default
        ...
        .populate('product.productId');
    if (existingCart) {
        const existingProductIndex = existingCart.product.findIndex(item => item.productId.equals(productId));
        if (existingProductIndex !== -1) {
