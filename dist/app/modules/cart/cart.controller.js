...
const updateCart = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const bulkUpdateCart = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const cartId = req.params.id
    const cartData = req.body
    const cart = yield cart_service_1.CartService.bulkUpdateCart(
      cartId,
      cartData
    )
    const responseData = {
...
const getCartByUserId = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const getCartByCartId = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const cartId = req.params.id
...
const deleteCart = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const cartId = req.params.id
...
const deleteAProductFromCart = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const cartId = req.params.id
    const productId = req.params.productId
    const cart = yield cart_service_1.CartService.deleteAProductFromCart(
      cartId,
      productId
    )
    const responseData = {
