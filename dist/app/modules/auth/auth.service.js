...
const generateRandomCode_1 = __importDefault(
  require('../../../shared/generateRandomCode')
)
const sendEmail_1 = __importDefault(require('../../helpers/sendEmail'))
const signupUser = userData =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { password } = userData,
      rest = __rest(userData, ['password'])
    const { email } = userData
    const accessToken = jsonwebtoken_1.default.sign(
      { email },
      config_1.default.access_token,
      {
        expiresIn: '1d',
      }
    )
    ...
    const user = yield user_model_1.default.create(
      Object.assign(Object.assign({ password: hashedPassword }, rest), {
...
const verifyOtp = (email, verificationCode) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (elapsedTime > 5 * 60 * 1000) {
      throw new ApiError_1.default(
        http_status_1.default.UNAUTHORIZED,
        'Expired otp code'
      ) // if otp code is expired use resend otp button in frontend
    }
    const verified = yield user_model_1.default.findOneAndUpdate(
      { email },
      { isVerified: true },
      { new: true }
    )
