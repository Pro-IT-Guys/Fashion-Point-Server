...
const convertImageToWebp_1 = __importDefault(
  require('../../helpers/convertImageToWebp')
)
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (Object.keys(uploadedFiles).length !== 0) {
      const frontImageWebP = uploadedFiles.frontImage.map(
        file => `${(0, convertImageToWebp_1.default)(file.filename)}`
      )
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (Object.keys(uploadedFiles).length !== 0) {
      ...
      if (uploadedFiles.restImage) {
        ...
        productData.restImage = `${product_constant_1.IMAGE_URL}/${restImageWebP}`
      }
    }
    const product = yield product_service_1.ProductService.updateProduct(
      productId,
      productData
    )
    const responseData = {
...
const getAllProduct = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const filters = (0, pick_1.default)(req.query, [
      'searchTerm',
      ...product_constant_1.PRODUCT_FILTER_FIELDS,
    ])
    const paginationOption = (0, pick_1.default)(
      req.query,
      shared_constant_1.paginationFields
    )
    const convertedFilters = (0,
    convertMultipleValuesIntoObject_1.convertMultipleValuesToObject)(filters)
...
const getProductById = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const productId = req.params.id
    const product = yield product_service_1.ProductService.getProductById(
      productId
    )
    const responseData = {
...
const getProductByPath = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const productPath = req.params.path
    const product = yield product_service_1.ProductService.getProductByPath(
      productPath
    )
    const responseData = {
      message: 'Product fetched successfully',
...
const getProductBySku = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const productSku = req.params.sku
    const product = yield product_service_1.ProductService.getProductBySku(
      productSku
    )
    const responseData = {
      message: 'Product fetched successfully',
...
const deleteProduct = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const productId = req.params.id
    const product = yield product_service_1.ProductService.deleteProduct(
      productId
    )
    const responseData = {
