...
const productFileUpload_1 = __importDefault(
  require('../../middlewares/productFileUpload')
)
const formatArrayField_1 = __importDefault(
  require('../../middlewares/formatArrayField')
)
const router = express_1.default.Router()
router.post(
  '/',
  // validateRequest(ProductValidation.createProductZodSchema),
  productFileUpload_1.default,
  formatArrayField_1.default,
  product_controller_1.ProductController.createProduct
)
router.get('/:id', product_controller_1.ProductController.getProductById)
router.get(
  '/path/:path',
  product_controller_1.ProductController.getProductByPath
)
