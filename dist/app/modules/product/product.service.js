...
const createProduct = (productData) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const product = yield product_model_1.default.create(Object.assign(Object.assign({}, productData), { sku }));
    if (!product)
...
const updateProduct = (productId, productData) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const product = yield product_model_1.default.findOneAndUpdate({ _id: productId }, productData, { new: true });
    if (!product)
