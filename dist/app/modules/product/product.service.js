...
const generateUniqueSKU_1 = __importDefault(
  require('../../helpers/generateUniqueSKU')
)
...
const createProduct = productData =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const product = yield product_model_1.default.create(
      Object.assign(Object.assign({}, productData), { sku })
    )
    if (!product)
...
const updateProduct = (productId, productData) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const product = yield product_model_1.default.findOneAndUpdate(
      { _id: productId },
      productData,
      { new: true }
    )
...
const getAllProduct = (filters, paginationOption) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { searchTerm } = filters,
      filterFields = __rest(filters, ['searchTerm'])
    const andConditions = []
    if (searchTerm) {
      andConditions.push({
    ...
    if (Object.keys(filterFields).length) {
      const fieldConditions = Object.entries(filterFields).map(
        ([key, value]) => {
          if (key === 'minPrice') {
            return {
              sellingPrice: {
...
const getProductByPath = path =>
  __awaiter(void 0, void 0, void 0, function* () {
    const product = yield product_model_1.default.findOne({ path })
    if (!product)
      throw new ApiError_1.default(
        http_status_1.default.BAD_REQUEST,
        'Product not found'
...
const getProductBySku = sku =>
  __awaiter(void 0, void 0, void 0, function* () {
    const product = yield product_model_1.default.findOne({ sku })
    if (!product)
      throw new ApiError_1.default(
        http_status_1.default.BAD_REQUEST,
        'Product not found'
...
const deleteProduct = productId =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const deletedProduct = yield product_model_1.default.findByIdAndDelete(
      productId
    )
    if (!deletedProduct) {
      throw new ApiError_1.default(
