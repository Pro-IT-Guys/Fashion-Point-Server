...
const createMessage = (messageData) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const message = (yield message_model_1.default.create(messageData)).populate([
        {
            path: 'chatId',
        },
        {
    ...
    if (!message)
        throw new ApiError_1.default(http_status_1.default.INTERNAL_SERVER_ERROR, 'Message not sent');
    return message;
});
const getMessageByChatId = (chatId) => __awaiter(void 0, void 0, void 0, function* () {
    const messages = yield message_model_1.default
        ...
        .sort({ createdAt: 1 });
    if (!messages)
        throw new ApiError_1.default(http_status_1.default.NOT_FOUND, 'Messages not found');
    return messages;
});
