...
const uploadMiddleware = (req, res, next) => {
    ...
    upload(req, res, (error) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (uploadedFiles === null || uploadedFiles === void 0 ? void 0 : uploadedFiles.frontImage) {
            ...
            const frontImageWebPPath = path_1.default.join(path_1.default.dirname(frontImagePath), `${path_1.default.basename(frontImagePath, frontImageExtension)}.webp`);
        ...
        if (uploadedFiles === null || uploadedFiles === void 0 ? void 0 : uploadedFiles.backImage) {
            ...
            const backImageWebPPath = path_1.default.join(path_1.default.dirname(backImagePath), `${path_1.default.basename(backImagePath, backImageExtension)}.webp`);
