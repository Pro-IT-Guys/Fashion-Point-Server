...
const offer_model_1 = __importDefault(
  require('./app/modules/offer/offer.model')
)
  ...
  return __awaiter(this, void 0, void 0, function* () {
    try {
      ...
      if (config_1.default.env === 'development') {
        ...
        logger_1.successLogger.info('Database connected successfully')
      }
