...
// Serve static files
app.use('/images/product', express_1.default.static(path_1.default.join(__dirname, '..', 'dist', 'public', 'images', 'product')));
// Define a route to handle the GET request for the images
app.get('/images/product/:filename', (req, res) => {
    const filename = req.params.filename;
    const imagePath = path_1.default.join(__dirname, '..', 'dist', 'public', 'images', 'product', filename);
